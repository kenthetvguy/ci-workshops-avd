...
| Ethernet2 | S1-LEAF1_Ethernet3 | *trunk | *10,15 | *- | *- | 2 |
| Ethernet3 | S1-LEAF2_Ethernet3 | *trunk | *10,15 | *- | *- | 2 |
...
| Port-Channel2 | RACK1_Po2 | switched | trunk | 10,15 | - | - | - | - | 2 | - |
...
| Vlan15 |  default  |  10.15.15.3/24  |  -  |  10.15.15.1  |  -  |  -  |  -  |
...
interface Vlan15
   description Fifteen
   no shutdown
   ip address 10.15.15.3/24
   ip virtual-router address 10.15.15.1
!
interface Vlan20
   description Twenty
   no shutdown
